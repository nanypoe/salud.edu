...
class planController extends Controller
{
    ...
    public function index()
    {
        ...
        $fila = $this->_plan->obtenerEjercicios();
    ...
    public function verPlan()
    {
        ...
        for ($i = 0; $i < count($fila); $i++) {
            ...
            <tr>
                ...
                <td>' . $fila[$i]['series'] . '</td>
                <td>
                <button data-plan=\'' . $datos . '\'  data-bs-toggle="modal" data-bs-target="#modalEditarPlan" type="button" style="color:white;font-weight:bold" class="btn btn-warning btnEditarPlan"><i class="fa-solid fa-rotate-right"></i> Actualizar</button>
